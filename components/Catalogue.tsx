...
const Catalogue = () => {
  ...
  return (
    <div>
        ...
        <div className="flex flex-row justify-center space-x-5 mt-24">
                <div className="bg-[#5159bb] w-[400px] sm:w-[600px] sm:h-[450px] text-center h-[350px] rounded-xl text-black flex flex-col items-center">
                <div className='relative mb-4'>
                    <Image src="/pic1.jpg" alt='photo' width={375} height={250} className="rounded-xl mt-6" />
                </div>
                ...
                <div className="bg-[#5159bb] w-[400px] sm:w-[600px] sm:h-[450px] text-center h-[350px] rounded-xl text-black flex flex-col items-center">
                <div className='relative mb-4 '>
                    <Image src="/pic2.jpg" alt='photo' width={375} height={250} className="rounded-xl mt-6" />
                </div>
